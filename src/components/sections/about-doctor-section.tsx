      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid gap-10 lg:grid-cols-2 lg:gap-16 items-center">
          ...
          <div className="space-y-6">
            ...
            <Button asChild size="xl" className="w-full sm:w-auto shadow-lg transition-all duration-300 hover:scale-105 hover:shadow-primary/40 active:scale-95 animate-pulse-strong">
